...
namespace FitData.Migrations
{
    ...
    [Migration("20250407183950_AddChatTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitCore.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitCore.Models.ChatMessage", b =>
                {
                    b.HasOne("FitCore.Models.ApplicationUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FitCore.Models.ApplicationUser", "Sender")
                        .WithMany()
